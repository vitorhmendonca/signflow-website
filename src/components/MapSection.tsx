      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-300 max-w-4xl mx-auto text-sm md:text-base">
            Partnering with businesses across the US, Canada, and Europe to drive growth and innovation. Whether it's a single city district or an entire country, our tailored approach ensures every client's unique needs are met.
          </p>
        </motion.div>
